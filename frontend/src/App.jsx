                                      ...
                                      .map((sol, idx) => {
                                        ...
                                        return (
                                          ...
                                          >
                                            ...
                                            {/* Estado */}
                                            <td>
                                              <span className={`edtech-equipos-status ${sol.estado === 'Aprobada' ? 'edtech-equipos-status-disp' : sol.estado === 'Rechazada' ? 'edtech-equipos-status-baja' : 'edtech-equipos-status-mant'}`}>
                                            ...
                                            <td style={{ textAlign: 'right', whiteSpace: 'nowrap' }}>
                                              {sol.estado === 'Pendiente' && (
                                                <div style={{ display: 'flex', gap: '6px', justifyContent: 'flex-end' }}>
                                                  <button className="edtech-equipos-btn-primary" style={{ padding: '6px 14px', width: 'auto' }} onClick={() => aprobarSolicitudMaterial(sol.id)}>Aprobar</button>
                                                  <button className="edtech-equipos-btn-danger" onClick={() => rechazarSolicitudMaterial(sol.id)}>Rechazar</button>
                                                </div>
                                              )}
                                            </td>
                                          </tr>
                                      ...
                                      .map((sol, idx) => {
                                        ...
                                        return (
                                          ...
                                          >
                                            ...
                                            {/* Acción */}
                                            <td style={{ textAlign: 'right' }}>
                                              <button className="edtech-equipos-btn-primary" style={{ padding: '6px 14px', width: 'auto' }} onClick={() => registrarDevolucionMaterial(sol.id)}>
                          ...
                          {listaSolicitudes.length === 0 ? (
                            ...
                            listaSolicitudes.map((sol) => (
                              <tr key={sol.id} className={sol.estado === 'Pendiente' ? 'row-highlight' : ''}>
                                ...
                                <td>
                                  <span className={`badge ${sol.estado === 'Aprobada' ? 'badge-success' :
